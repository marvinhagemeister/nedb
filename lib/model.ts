 ...
 */
export function compareThings(a: any, b: any, _compareStrings?: any) {
  var aKeys,
    bKeys,
    comp,
    i,
 ...
 */
lastStepModifierFunctions.$set = function(obj, field: string, value) {
  obj[field] = value;
};
 ...
 * Unset a field
 */
lastStepModifierFunctions.$unset = function(obj, field: string, value) {
  delete obj[field];
};
 ...
 * @param {String} field
 */
export function getDotValue(obj, field: string) {
  var fieldParts = typeof field === "string" ? field.split(".") : field,
    i,
    objs;
